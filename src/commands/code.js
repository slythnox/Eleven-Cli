...
async function handleCode(prompt, options = {}) {
  try {
    ...
    if (options.file) {
      ...
      console.log(chalk.gray('  eleven code "create a function to sort an array"'));
      console.log(chalk.gray('  eleven code -f myfile.js'));
      console.log(chalk.gray('  eleven code -l python "create a web scraper"'));
      return;
    }
